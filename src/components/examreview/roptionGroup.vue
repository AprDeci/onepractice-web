...
<template>
    <div class="optionsgroup">
        ...
        <div class="rounded-lg h-min-12 my-2 w-full border flex items-center p-3 border-base-300 " :class="{
            'border-green-400 bg-green-50': option.label === selected && paperSotre.currentAnswerStatus[questionindex],
            'border-red-400 bg-red-50': option.label === selected && !paperSotre.currentAnswerStatus[questionindex]
