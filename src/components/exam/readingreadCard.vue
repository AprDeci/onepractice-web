...
<template>
    <div class="max-w-6xl mx-auto p-6 bg-white dark:bg-base-200 rounded-xl shadow-lg">
        <h2 class="text-2xl font-bold text-gray-800 mb-4 dark:text-gray-200">{{ question.partName }}: {{
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-7 order-1">
                <div class="" ref="leftpart">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg hidden lg:block">
                ...
                <div class="space-y-8">
                    <div v-for="(question, index) in questions" :key="`q-${index}`" :id="`question-${index}`"
                        ...
                        <div class="flex items-start mb-4">
                            ...
                            <h4 class="text-lg font-medium text-gray-800 dark:text-gray-200">{{ question.content }}</h4>
                        </div>
