...
<template>
    <loginBg>
        <!-- 注册 -->
        <div class="register-card card  w-120 bg-base-100 shadow-xl">
            <div class="card-title mt-6 ml-5">注册</div>
            <div class="card-body pt-2">
                <fieldset class="fieldset">
                    <legend class="fieldset-legend">用户名</legend>
                    <input v-model="registerdata.username" type="text" class="input validator w-full input-lg"
                ...
                <fieldset class="fieldset">
                    ...
                    <label class="input validator w-full input-lg">
                ...
                <fieldset>
                    ...
                    <div class="join">
                        <input v-model="registerdata.captchacode" type="text"
                            class="input lg:input-lg  rounded-sm join-item w-40 lg:w-90" placeholder="Type here" />
                ...
                <fieldset>
                    ...
                    <label class="input validator w-full input-lg">
                        ...
                        <input v-model="registerdata.password" class="" type="password" required placeholder="Password"
                            minlength="6" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z][^\s]{5,}$" />
                    </label>
                    <p class="validator-hint hidden">
                        密码至少六位,字母开头包含数字
                    </p>
