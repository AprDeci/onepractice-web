...
<template>
    <h1>隐私政策</h1>
    <div>更新日期：<strong>2025/4/10</strong></div>
    <div>生效日期：<strong>2025/4/10</strong></div>
    <h2>导言</h2>
    <p>
        <i>onepractice</i> 是一款由 <i>孟夏十二工作室</i> （以下简称“我们”）提供的产品。
        您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务时，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。
        本《隐私政策》与您所使用的 <i>onepractice</i>
    ...
    <p>如对本《隐私政策》或相关事宜有任何问题，请通过 <strong>luchen126@gmail.com</strong> 与我们联系。</p>
