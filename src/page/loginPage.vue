...
const cooldownchange = () => {
    ...
    console.log(cooldownElement)
    const interval = setInterval(() => {
        if (counter > 0) {
            counter--
        }
        if (cooldownElement) {
            cooldownElement.style.setProperty('--value', counter.toString())
        }
        console.log(counter)
        if (counter === 0) {
            ...
            <div class="register-card card h-auto w-80 bg-base-100 shadow-xl" v-if="!islogin">
                ...
                <div class="card-body pt-2">
                    ...
                    <fieldset>
                        ...
                        <div class="join">
                            <input type="text" class="input  rounded-sm join-item w-56" placeholder="Type here" />
                            <button class="btn join-item btn-primary" v-show="!hasSendEmail"
                                @click="sendEmail">发送验证码</button>
                            <button class="btn btn-primary join-item" v-show="hasSendEmail">
                                <span class="countdown">
                                    <span id="cooldown" style="--value:59;" aria-live="polite" aria-label="59">59</span>
                                </span>
                            </button>
                        </div>
                    </fieldset>
                    ...
                    <button class="btn btn-primary btn-md mt-2">注册</button>
                ...
                <div class="tabs tabs-border">
                    ...
                    <div class="tab-content">
                        <div class="card-body pt-2">
                            ...
                            <button class="btn btn-primary btn-md mt-2">登陆</button>
