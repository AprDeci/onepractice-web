...
/**
  ...
  *
  * @checksum - ebfddf485c8d1fa412958136b02fd07978f41e6ab994e3a4cac2e3d1eb24fe2a
  * @variables - radius=rounded,accentColor=green,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
